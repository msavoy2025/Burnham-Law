...
function crb_gform_ajax_spinner_url( $image_src, $form ) {
	if ( is_page_template( 'templates/ppc-v2.php' ) || is_page_template( 'templates/ppc.php' ) ) {
		return get_bloginfo( 'stylesheet_directory' ) . '/resources/images/spinner-xsmall.svg';
	} elseif ( is_page_template( 'templates/seo-page.php' ) ) {
		return get_bloginfo( 'stylesheet_directory' ) . '/resources/images/spinner-xsmall-black.svg';
	} else {
		return get_bloginfo( 'stylesheet_directory' ) . '/resources/images/spinner-small.svg';
	}
}
