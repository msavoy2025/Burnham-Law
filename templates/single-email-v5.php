                    ...
                    <tr>
                      ...
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td style="font-size: 10px; letter-spacing: 1px; line-height: 13px; color: #a6a6a6; font-family: Arial, sans-serif; text-align: left; font-weight: normal; min-width: auto !important; text-transform: uppercase; padding-bottom: 20px;">
