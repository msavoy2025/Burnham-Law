<?php
if ( ! $members = carbon_get_term_meta( $practice_area_id, 'crb_cta_members' ) ) {
	return;
}
...
$headline   = carbon_get_term_meta( $practice_area_id, 'crb_cta_headline' );
$btn_label  = carbon_get_term_meta( $practice_area_id, 'crb_cta_btn_label' );
$btn_target = carbon_get_term_meta( $practice_area_id, 'crb_cta_btn_target' );
$btn_url    = carbon_get_term_meta( $practice_area_id, 'crb_cta_btn_url' );
?>

<div class="helpCenterCTA">
  <div class="helpCenterCTA_left">
  	<?php if ( $subhead = carbon_get_term_meta( $practice_area_id, 'crb_cta_subhead' ) ) : ?>
    ...
    <?php if ( $content = carbon_get_term_meta( $practice_area_id, 'crb_cta_content' ) ) : ?>
    	<p><?php echo nl2br( esc_html( $content ) ); ?></p>
    <?php endif ?>

    <div class="helpCenterCTA_inner">
    	<?php if ( $phone = carbon_get_term_meta( $practice_area_id, 'crb_cta_phone' ) ) : ?>
    	...
    	<?php if ( $locations = carbon_get_term_meta( $practice_area_id, 'crb_cta_locations' ) ) : ?>
